...
const ReuseSearchInput: React.FC<ReuseSearchInputProps> = ({
  ...
  return (
    <ReuseInput
      ...
      inputClassName="!bg-[#F3F3F5] !w-full !text-base-color !border-none placeholder:!text-[#717182] !rounded-lg"
      prefix={<SearchOutlined className="!text-[#99A1AF] text-xl mr-2" />}
    />
  );
};
