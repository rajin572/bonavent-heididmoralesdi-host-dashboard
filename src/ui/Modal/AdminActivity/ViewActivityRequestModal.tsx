...
interface ViewActivityRequestModalProps {
  isViewModalVisible: boolean;
  handleCancel: () => void;
  currentRecord: any;
}
const ViewActivityRequestModal: React.FC<ViewActivityRequestModalProps> = ({
  isViewModalVisible,
  handleCancel,
  currentRecord,
}) => {
            ...
            <div>
              ...
              <div className="flex  items-center gap-2 mt-8">
                <Tooltip placement="left" title="Approve this Activity">
                  <button
                    className="!py-3 px-10 rounded-lg !bg-success-color !text-primary-color !border-none text-xs lg:text-sm cursor-pointer"
                ...
                <Tooltip placement="left" title="Decline this Activity">
                  <button
                    className="!py-3 px-10 rounded-lg !border-none !bg-error-color text-primary-color text-xs lg:text-sm cursor-pointer"
...
export default ViewActivityRequestModal;
