...
const ConversationChatListCard = ({
  ...
  return (
    <div
      ...
      className={`m-1 rounded  border-b border-secondary-color/10 bg-secondary-color/10 text-black ${conversation?._id === selectedConversation?._id
              ...
              <div className="flex items-center gap-2">
                <div className="flex items-center gap-1">
                  <p className="text-base mb-1">
                    ...
                    {conversation?.fullName?.length > 15
                      ? `${conversation?.fullName?.slice(
                        0,
                        15
                      )}...`
            ...
            <div className="flex justify-between items-center w-full">
              <div className="text-[11px]">
                {conversation?.lastMessage?.text?.length > 0
                  ...
                  : conversation?.lastMessage?.file?.length > 0
                    ? "Send Attachment"
                    : ""}
              </div>
